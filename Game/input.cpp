	...
	while(SDL_PollEvent(&event))
	{
		...
		case SDL_KEYDOWN:
			...
			case SDL_SCANCODE_RSHIFT:
				if (!is_button_state(Button::PUNCHING, Button_State::DOWN))
				{
					_button_state[Button::PUNCHING] = Button_State::PRESSED;
				}
				break;
			}
			break;
		case SDL_KEYUP:
			...
			case SDL_SCANCODE_LSHIFT:
				...
				break;
			case SDL_SCANCODE_RSHIFT:
				_button_state[Button::PUNCHING] = Button_State::RELEASED;
				break;
			}
			break;
		}
